...
class Providers {
  ...
  static final nakamaAuthProvider =
      AsyncNotifierProvider<NakamaAuthNotifier, bool>(
    NakamaAuthNotifier.new,
  );

  static final nakamaLeaderboardProvider = AsyncNotifierProvider<
      NakamaLeaderboardNotifier, List<LeaderboardRecordModel>>(
